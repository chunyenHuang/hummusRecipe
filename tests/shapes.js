...
describe('Regular Polygons, Stars, Arrows', () => {
    ...
    it('Add arrows', (done) => {
        ...
        recipe
            ...
            .line([[cx-sl+5,cy],[cx,cy]], {color:'red', width:1,dash:[10,3]})
            .line([[cx,cy-(sw/2)],[cx,cy+(sw/2)]], {color:'red', width:1,dash:[10,3]})
            .line([[cx-5,cy],[cx+5,cy]], {width:1.5, lineCap:'butt', color:'#000000'})
            .line([[cx,cy-5],[cx,cy+5]], {width:1.5, lineCap:'butt', color:'#000000'})
            .text('shaft', cx-60, cy-(sw/2)-15, {color:'#ff00ff'})
            .text('arrowhead',  cx+15, cy-5)
            .text('width', cx-175, cy-5)
            .line([[cx-120,cy-50], [cx-125,cy-50], [cx-125,cy+50], [cx-120,cy+50]], {width:.5, lineCap:'butt', color:'#ff00ff'})

            .line([[cx-120,cy-sw], [cx-130,cy-sw], [cx-130,cy+sw], [cx-120,cy+sw]], {width:.5, lineCap:'butt'})
            .line([[cx-115,cy-sw], [cx-5,cy-sw]], {width:.5, lineCap:'butt', dash:[4], dashPhase:6})
                        
            // length description
            .text('length', cx-15, cy+sw+30)
            .line([[cx-sl,cy+sw+10], [cx-sl,cy+sw+20], [cx,cy+sw+20], [cx,cy+sw+10]], {width:.5, lineCap:'butt', color:'#ff00ff'})
            .line([[cx,cy+sw+20], [cx+sl,cy+sw+20], [cx+sl,cy+sw+10]], {width:.5, lineCap:'butt'})

            // tail marker
            .line([[cx-sw,cy-5],[cx-sw,cy+5]],{width:2,lineCap:'butt',color:'#ffffff'})
        ...
        recipe
            ...
            .line([[x-50,y-3],[x-50,y-16]],{width:.3,color:'red'})
            .line([[x+50,y-3],[x+50,y-16]],{width:.3,color:'red'})
