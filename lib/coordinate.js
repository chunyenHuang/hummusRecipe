...
exports._calibrateCoorinateForAnnots = function _calibrateCoorinateForAnnots(x, y, offsetX = 0, offsetY = 0, pageNumber) {
    const { nx: tx, ny: ty } = this._calibrateCoorinate(x, y, offsetX, offsetY, pageNumber);
...
exports._reverseCoorinate = function _reverseCoorinate(x, y, offsetX = 0, offsetY = 0, pageNumber) {
    pageNumber = pageNumber || this.pageNumber;
