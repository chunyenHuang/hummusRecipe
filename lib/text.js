    ...
    if (this._flow) {
        ...
        toWriteTextObjects.some((toWriteTextObject, index) => {
            ...
            const writeText = (context, x, y, wto) => {
                ...
                const { lineHeight, text, baseline, lineWidth } = wto;
                let next_x = 0;
                ...
                if (options.opacity === 1 && options.colorspace !== 'separation' &&
                    ...
                    if (_justify) {
                        ...
                        emitTextObject(text, x, y + baseline, context, {...options, lineWidth});
                    }
                    ...
                    if (_justify) {
                        ...
                        emitTextObject(text, x - nx, baseline, xObjectCtx, {...options, lineWidth});
                    }
